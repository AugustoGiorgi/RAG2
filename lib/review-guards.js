...
const MISSING_FORM_CLAIM = /\b(?:not attached|is not attached|are not attached|no longer attached|missing|not present|not included|not in the package|was not provided|does not include|omitted|not listed)\b/i;
