...
function checkboxes1040(text) {
  ...
  return {
    ...
    // Sin deduccion estandar completa: el conyuge itemiza por separado o el contribuyente es dual-status.
    noStandard: /\bX\s+Spouse itemizes on a separate return|\bX\s+You were a dual-status alien/i.test(block),
  };
}
