...
const RECONCILIATION_PROMPT_LINES = [
  ...
  "  • homeOffice: ENTITY-SPECIFIC. 1065 partnership: a partner's home office is deductible as Unreimbursed Partnership Expense (UPE) on the partner's Schedule E or via an accountable plan — deductible, NOT an addback. 1120-S: UPE does NOT exist for S-corp shareholders — the ONLY deductible route is an accountable-plan reimbursement booked as an entity expense; an unreimbursed shareholder home office is NOT deductible (flag it in aiNotes if found). Either entity: set homeOffice to 0 (or a NEGATIVE amount only when recording a supported additional deduction). NEVER a positive addback that increases ordinary income.",
